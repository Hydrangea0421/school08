...
public class Janken {
	...
	static private String[] te = {"グー","チョキ","パー"};
	static int[][] judge = {
...
//		System.out.println(judge[GOO][PAA]);
		boolean flag = true;
		while (flag) {
			int ret1 = TanabeFighter.getTe();
			int ret2 = TanabeFighter.getTe();
			System.out.println("tanabe1さんが" + te[ret1]);
			System.out.println("tanabe2さんが" + te[ret2]);
			switch (judge[ret1][ret2]) {
				...
				case KACHI_1:
					flag = false;
					System.out.println("tanabe1さんの勝ち");
					break;
				case KACHI_2:
					flag = false;
					System.out.println("tanabe2さんの勝ち");
					break;
			}
		}
	}
